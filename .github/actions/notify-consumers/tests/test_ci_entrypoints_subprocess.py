...
def test_notify_entrypoint_files_and_places_a_ticket_through_a_real_subprocess(tmp_path):
    ...
    env = {
        "VERSION": "0.2.0",
        "SOURCE_REPO": "Seretos/lib-python-projects",
        "CONSUMERS": "Seretos/agent-project-issues",
        "GH_TOKEN": "fake-token",
        ...
        "FAKE_GH_ISSUE_URL": "https://github.com/Seretos/agent-project-issues/issues/123",
    }
    ...
    assert "https://github.com/Seretos/agent-project-issues/issues/123" in text
